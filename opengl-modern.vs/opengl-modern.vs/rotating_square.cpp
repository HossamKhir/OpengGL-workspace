...
// shader source codes
// vertex shader
const GLchar* pglcRotatingSquareVertex120 = R"END(
	 #version 120
...
// fragment shader
const GLchar* pglcRotatingSquareRaster120 = R"END(
	 #version 120
	 varying vec4 outColour;
	 void main()
	 {
...
rotating_square(void)
{
	...
	glShaderSource(gluVertexShader, 1, &pglcRotatingSquareVertex120, 0);
	...
	glShaderSource(gluFragmentShader, 1, &pglcRotatingSquareRaster120, 0);
